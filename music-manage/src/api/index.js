...
const HttpManager = {
  ...
  // =======================> 歌单歌曲 API
  // 返回歌单里指定歌单ID的歌曲
  getListSongOfSongId: (songListId) => get(`list/detail?songListId=${songListId}`),
  // 给歌单添加歌曲
  setListSong: (params) => post(`list/add`, params),
  // 删除歌单里的歌曲
  deleteListSong: (params) => post(`list/delete`,params),
  // =======================> 搜索 API
  // 返回指定歌手名的歌曲
