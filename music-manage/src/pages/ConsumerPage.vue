  ...
  <div class="table">
    ...
    <el-dialog title="添加用户" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="addPeople" :disabled="isClick">确 定</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  computed: {
    ...
    isClick() {
      return !(this.registerForm.username && this.registerForm.password && this.registerForm.sex && this.registerForm.birth
        && this.registerForm.introduction && this.registerForm.location)
    }
  },
  watch: {
