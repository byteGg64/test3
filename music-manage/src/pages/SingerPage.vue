  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" class="handle-input mr10" size="mini" placeholder="筛选关键词"/>
    ...
    <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form
        ...
        <el-form-item prop="location" label="故乡" size="mini">
          <el-input v-model="registerForm.location" placeholder="故乡"/>
        </el-form-item>
        ...
        <el-form-item prop="introduction" label="歌手介绍" size="mini">
          <el-input v-model="registerForm.introduction" type="textarea" placeholder="歌手介绍"/>
        </el-form-item>
      </el-form>
      <span class="dialog-footer" slot="footer">
        <el-button size="mini" @click="centerDialogVisible = false">取 消</el-button>
        <el-button type="primary" size="mini" @click="addsinger" :disabled="isClick" >确 定</el-button>
      </span>
    </el-dialog>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      isClick() {
        return !(this.registerForm.name && this.registerForm.sex && this.registerForm.birth && this.registerForm.location
