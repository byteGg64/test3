  ...
  <div class="table">
    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form action="" :model="registerForm" id="tf">
        <div>
          <label>歌曲名</label>
          <el-input type="text" name="name" v-model="registerForm.name"/>
        </div>
        <div>
          <label>专辑</label>
          <el-input type="text" value="" name="introduction" v-model="registerForm.introduction"/>
        </div>
        <div>
          <label>歌词</label>
          <el-input type="textarea" value="" name="lyric" v-model="registerForm.lyric"/>
        </div>
        <div>
          <label>歌曲上传</label>
          <br>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addSong" :disabled="isClick">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="编辑" :visible.sync="editVisible" width="400px">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="歌词" size="mini">
          <el-input type="textarea" v-model="form.lyric"/>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      isClick() {
        return !(this.registerForm.name && this.registerForm.introduction)
      },
      playIcon() {
        if (this.isPlay) {
          return this.ZANTING
    ...
    methods: {
      ...
      addSong() {
        ...
        req.open('post', `${_this.$store.state.HOST}/song/add`, true);/*[Deprecation]Synchronous XMLHttpRequest on the main thread is deprecated because of its detrimental effects to the end user's experience. For more help, check https://xhr.spec.whatwg.org/.*/
        req.send(form);
