  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" size="mini" placeholder="筛选关键词" class="handle-input mr10"/>
      ...
      <el-table
        ...
        <el-table-column prop="name" label="歌手-歌曲"/>
    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="getSongId" :disabled="isClick">确 定</el-button>
      </span>
    </el-dialog>
...
<script>
  ...
  export default {
    ...
    computed: {
      isClick() {
        return !(this.registerForm.singerName && this.registerForm.songName)
      }
    },
    watch: {
    ...
    methods: {
      ...
      getSongId() {
        ...
        HttpManager.getSongOfSingerName(name)
          .then(res => {
            for (let item of res) {
              this.addSong(item.id)
            }
          })
      },
      // 添加歌曲
      ...
      deleteRow() {
        ...
        HttpManager.deleteListSong(params)
          .then(res => {
            if (res) {
              this.getData();
