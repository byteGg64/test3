    ...
    <el-dialog title="添加歌单" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form :model="registerForm" status-icon ref="registerForm" label-width="70px" class="demo-ruleForm">
          ...
          <el-form-item label="歌单介绍" prop="introduction" size="mini">
            <el-input v-model="registerForm.introduction" placeholder="歌单介绍"/>
          </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="addsongList" :disabled="isClick">确 定</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  computed: {
    // 计算当前表格中的数据
    data () {
      //true则不能点击，false则可以点击
      return this.tableData.slice((this.currentPage - 1) * this.pageSize, this.currentPage * this.pageSize)
    },
    isClick() {
      return !(this.registerForm.title && this.registerForm.introduction && this.registerForm.style )
    }
  },
  watch: {
